    ...
    <div className="app">
      ...
      <header className="header">
        <div className="container">
          <div className="logo">🏢 Kılınç Market</div>
        ...
        <div className="container">
          ...
          <div className="about-content">
            ...
            <div style={{marginTop: '1.5rem', padding: '1rem', backgroundColor: '#f8f9fa', borderRadius: '8px'}}>
                ...
                <br />
                <a href="https://egecrew.github.io/website-kilinc-market/" target="_blank" rel="noopener noreferrer" style={{color: '#0066cc'}}>
                  egecrew.github.io/website-kilinc-market
                </a>
              </div>
              </div>
        ...
        <div className="container">
          ...
          <div className="services-grid">
            ...
            <div className="service-card">
              ...
              <p>Kılınç Marketin büyümesine katkı sağlayacak stratejiler ve çözümler.</p>
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="contact-content">
            <div className="contact-info">
              ...
              <div className="info-item">
                ...
                <div>
                  <h3>Adres</h3>
                  <p>Umurca, Artemis Cd. No:19/A, 48400 Bodrum/Muğla, Türkiye</p>
                </div>
              </div>
      ...
      <footer className="footer">
        <div className="container">
          <div className="footer-content">
            ...
            <div className="footer-section">
              <h4>İletişim</h4>
              <p>+90 252 559 0283<br/>iletisim@isletme.com</p>
            </div>
          </div>
          <div className="footer-bottom">
            <p>&copy; 2026 Kılınç Market. Tüm hakları saklıdır.</p>
